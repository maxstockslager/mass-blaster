...
settings.quantile_width = 500; % width of moving quantile window. 500>3000
...
settings.min_peak_duration = 20/1000; % sec
settings.max_peak_duration = 150/1000; % sec

settings.detection_threshold = -0.5 % Hz
settings.pad_indices_ratio = 1; % pad the peak with this multiple of its length on either side 
settings.baseline_fraction = 0.15; % for detection, baseline is this fraction of signal at beginning/end
settings.peak_fit_window_fraction = 0.1;
